...
function drawingMode(param) {
    ...
    let navigationbutton = makeElement('mode-button', `<img src='../static/zoomtracker/img/navigation.svg' />`);
    ...
    let downloadbutton = makeElement('mode-button button-download', `<img src='../static/zoomtracker/img/download.svg' />`);
    ...
    downloadbutton.addEventListener('click', function() {
        if (hasClass(downloadbutton, 'active')) {
            ...
            results['filename'] = 'zoomtracker-' + year.toString() + month.toString() + day.toString() + hour.toString() + minutes.toString() + seconds.toString();
    ...
    let layeradd = makeElement('add-layer', `<img src='../static/zoomtracker/img/layer.svg' />`);
    ...
    function addLayer(param, callback) {
        ...
        let changecolor = makeElement('color-change', `<img src='../static/zoomtracker/img/change.svg' />`);
        changecolorcontainer.appendChild(changecolor);
        let rename = makeElement('color-rename color-input-items', `<img src='../static/zoomtracker/img/rename.svg' />`);
        ...
        let deletecolor = makeElement('color-delete color-input-items', `<img src='../static/zoomtracker/img/clear.svg' />`);
        ...
        for (c = 0; c < controls.length; ++c) {
            ...
            let button = makeElement('drawing-control-button ' + name + '-button', `<img src='../static/zoomtracker/img/${name}.svg' />`);
        ...
        function changeLayerColor(event) {
            ...
            let randomcolor = makeElement('random-color color-change-items hidden', `<img src='../static/zoomtracker/img/random.svg' />`);
            ...
            let validatecolor = makeElement('validate-color color-change-items hidden', `<img src='../static/zoomtracker/img/validate.svg' />`);
            ...
            waitMap(0.2, function() {
                ...
                function validateColor() {
                    ...
                    waitMap(0.2, function() {
                        ...
                        changecolor = makeElement('color-change hidden', `<img src='../static/zoomtracker/img/change.svg' />`);
                        changecolorcontainer.appendChild(changecolor);
