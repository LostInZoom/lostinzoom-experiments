...
function createInterface(param) {
    ...
    let geoinfoscontainer = makeElement('geo-infos-container', '', 'geo-infos');
    let geoinfos = makeElement('geo-infos', `<img src='../static/zoomtracker/img/help.svg' />`);
    ...
    let projectionchange = makeElement('projection-change', `<img src='../static/zoomtracker/img/earth.svg' />`);
